...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-xl border border-input bg-white/80 px-4 py-2 text-sm shadow-sm outline-none focus:ring-2 focus:ring-ring dark:bg-slate-900/70",
      className,
    )}
    {...props}
  >
